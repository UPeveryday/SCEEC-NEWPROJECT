...
namespace SCEEC.MI.High_Precision
{
    ...
    public class High_PrecisionClass
    {
        ...
        public byte ChangeTestCn(float testCn = 1e-12f, float CnTan = 0.01f)
        {
            ...
            if (testCnBuffer.Length == 4)
            {
                ...
                byte[] Issuccss = new byte[1];
                byte[] TestComman = { 0x8A, testCnBuffer[0], testCnBuffer[1], testCnBuffer[2], testCnBuffer[3],testCnTanBuffer[0],
                    testCnTanBuffer[1], testCnTanBuffer[2], testCnTanBuffer[3],
                    CheckData(new byte[9] { 0x8A, testCnBuffer[0], testCnBuffer[1], testCnBuffer[2], testCnBuffer[3] ,testCnTanBuffer[0],
                    testCnTanBuffer[1], testCnTanBuffer[2], testCnTanBuffer[3]}) };
                if (0 < LocalPrecision.SendCommand(TestComman, ref Issuccss, 10))
                    return Issuccss[0];
                else
